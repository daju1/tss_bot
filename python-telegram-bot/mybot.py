...
if __name__ == '__main__':
    ...
    if YOUR_TELEGRAM_BOT_TOKEN is None:
        print("YOUR_TELEGRAM_BOT_TOKEN is None", flush=True)
    else:
        print("YOUR_TELEGRAM_BOT_TOKEN = " + YOUR_TELEGRAM_BOT_TOKEN, flush=True)

        application = ApplicationBuilder().token(YOUR_TELEGRAM_BOT_TOKEN).build()

        test_my_chat = TestChatWithoutRequest()
