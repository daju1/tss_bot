...
@auth.login_required
def reinitActualStock():
    if request.method == 'GET':
        return '''
            <form method="post">
                <p><input type="text" name="xls_dir" value = "../../xls/"></p>
                <p><input type="text" name="xls_ma" value = "20180322 Materials Availability.xlsx"></p>
                <p><input type="text" name="xls_stock" value = "Stock door code.xlsx"></p>
                <p><input type="text" name="xls_matrix" value = "Матрица по салонам.xlsx"></p>
                <p><input type="text" name="xls_bo" value = "BO_transit_test_Monokl.xlsx"></p>
                <p><input type=submit value='reinit Actual Stock'></p>
            </form>
            '''
    if request.method == 'POST':
        #Тут пересчитать xlsx файлы
        #worker.tools.init_read()

        #try:
        #    xls_new_dir = request.form['xls_dir']
        #    xls_ma = request.form['xls_ma']
        #    xls_stock = request.form['xls_stock']
        #    xls_matrix = request.form['xls_matrix']
        #    xls_bo = request.form['xls_bo']
        #    xls_doors = request.form['xls_doors']

        #    print('xls_dir', xls_dir)
        #    print('xls_ma', xls_ma)
        #    print('xls_stock', xls_stock)
        #    print('xls_matrix', xls_matrix)
        #    print('xls_bo', xls_bo)
        #    print('xls_doors', xls_doors)
        ...
        #    ma_xls     = xls_ma, 
        #    stock_xls  = xls_stock, 
        #    matrix_xls = xls_matrix,
        #    bo_xls     = xls_bo,
        #    doors_xls  = xls_doors
        #    )

        return "Reinit success", 200
